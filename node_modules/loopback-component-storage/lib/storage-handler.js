...
exports.upload = function (provider, req, res, options, cb) {
  ...
  form.onPart = function (part) {
    try {
      var oldname = part.filename;
      var ext = '';
      if (isValidFileName(oldname)) {
        ext = getExt(oldname);
        part.filename = randFilename() + "." + ext;
      }
    } catch (e) {
      console.error(e);
    }
  ...
  form.parse(req, function (err, _fields, _files) {
    ...
    //try{
    //    var oldname = _files.file.name;
    //    var ext = '';
    //    if (isValidFileName(oldname)) {
    //      ext = getExt(oldname);
    //      _files.file.name = randFilename() + "." + ext;
    //      fs.renameSync("./server/storage/image/" + oldname, "./server/storage/image/" + _files.file.name);
    //    }
    //}catch(e){
    //  console.error(e);
    //}
